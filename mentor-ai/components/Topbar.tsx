    ...
    return (
        <header className="sticky top-0 z-30 flex items-center justify-between gap-3 border-b border-t-0 border-r-0 border-l-0 border-white/5 bg-black/40 px-4 py-4 shadow-[0_10px_30px_rgba(0,0,0,0.5)] glass lg:px-8">
            <div className="flex min-w-0 flex-1 items-center gap-3">
                ...
                <div className="flex min-w-0 flex-1 items-center gap-3 rounded-2xl border border-white/10 bg-white/5 px-4 py-2.5 shadow-inner transition-all focus-within:border-purple-500/50 focus-within:bg-white/10 lg:w-96 lg:max-w-lg lg:flex-none">
            ...
            <div className="flex items-center gap-3 lg:gap-5">
                ...
                <Link href="/profile" className="flex items-center gap-3 border-l border-white/10 pl-3 lg:pl-4 cursor-pointer group">
